...
export const PRODUCTS: Product[] = [
  // ==================== LIVING ROOM ====================
  {
    ...
    description: 'Designed as the centerpiece for thoughtful living spaces, our Ochre Sectional features organically curved silhouettes, high-resilience memory foam cushioning, and hand-tailored cotton velvet with kiln-dried solid plantation teak inner framework engineered for lifetime durability.',
    features: [
  ...
  },
  {
    ...
    subtitle: 'Ergonomic Accent Armchair with Brass Legs & Warm Velvet Upholstery',
    category: 'living',
    priceINR: 64500,
    mrpINR: 78000,
    rating: 4.9,
    ...
    description: 'Inspired by Japanese minimalism and Nordic comfort. Features a gently reclined pitch, solid ash internal frame, and antiqued brass leg caps. Upholstered in plush velvet or full-grain leather with ergonomic lumbar support.',
    features: [
      'Ergonomic 105° recline angle for optimal spine alignment',
      'Solid kiln-dried hardwood frame structure',
      'Antiqued brushed brass foot caps',
      'High-resilience contoured foam cushioning'
    ],
    materials: ['Solid Ash Wood', 'Brushed Brass', 'Cotton Velvet / Leather'],
    dimensions: {
      widthCm: 85,
      depthCm: 90,
      heightCm: 88,
  ...
  },
  {
    ...
    subtitle: '4-Door Sideboard with Fluted Wood Slats and Brass Pulls',
    category: 'living',
    priceINR: 98000,
    mrpINR: 115000,
    rating: 4.7,
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=1200&q=80',
    images: [
  ...
  },
  {
    ...
    name: 'Jodhpur Carved Teak Coffee Table',
    subtitle: 'Organic Solid Wood Low Table with Sculpted Legs',
    category: 'living',
    priceINR: 48000,
    mrpINR: 56000,
    rating: 4.8,
    ...
    description: 'Sculpted from thick slabs of solid plantation teak wood. Features smooth organic soft edges, hand-turned tapered legs, and subtle brass inlay detailing.',
    features: [
      '100% Solid Teak Wood tabletop with natural grain variations',
      'Waterproof organic clear matte wax seal',
      'Tapered solid teak legs',
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=1200&q=80',
    images: [
  ...
  },
  {
    ...
    subtitle: 'Table + 4 Chairs + 1 Solid Wood Bench in Warm Honey Finish',
    category: 'dining',
    priceINR: 96000,
    mrpINR: 112000,
    rating: 4.8,
  ...
  },
  {
    ...
    subtitle: 'Artisan Carved Chest of Drawers with Solid Brass Knobs',
    category: 'bedroom',
    priceINR: 92000,
    mrpINR: 110000,
    rating: 5.0,
    ...
    description: 'Masterwork of Jodhpur woodworking. Constructed entirely of solid teak timber with hand-carved subtle geometric drawer faces. Features full-extension solid wood drawer runners and soft magnetic closures.',
    features: [
  ...
  },
  {
    ...
    name: 'Fluted Solid Teak Bedside Table',
    subtitle: 'Nightstand with Soft-Close Drawers & Brass Pulls',
    category: 'bedroom',
    priceINR: 32000,
    mrpINR: 38000,
    rating: 4.9,
    ...
    description: 'Solid teak nightstand featuring fluted front details, soft-closing drawers, and felt-lined interiors for jewelry and watches.',
    features: [
      'Handcrafted in 100% solid teak timber',
  ...
  // ==================== OFFICE ====================
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?auto=format&fit=crop&w=1200&q=80',
    images: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?auto=format&fit=crop&w=1200&q=80',
    images: [
  ...
  },
  {
    ...
    description: 'Combines bent walnut wood shell with supple top-grain cognac leather cushions. Features 360-degree pneumatic swivel and tilt mechanism with solid brass star base.',
    features: [
      'Bent solid walnut frame with teak structural core',
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4?auto=format&fit=crop&w=1200&q=80',
    images: [
